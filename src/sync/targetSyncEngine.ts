...
function toRemoteRow(entity: TargetEntityName, value: TargetEntity) {
  switch (entity) {
    ...
    case 'stageSessions': {
      ...
      return { id: v.id, service_id: v.serviceId, legacy_band_stage_session_id: v.legacyBandStageSessionId ?? null, md_user_id: v.mdUserId ?? null, status: v.status, created_at: v.createdAt, started_at: v.startedAt ?? null, ended_at: v.endedAt ?? null, updated_at: v.updatedAt }
    }
