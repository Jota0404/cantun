  ...
  return (
    <div className={`shell${isStageMode ? ' shell--stage' : ''}`}>
      ...
      <Routes>
        ...
        <Route path="/stage/setlist/:setlistId" element={<StagePage />} /><Route path="/stage/song/:songId" element={<StagePage />} /><Route path="/stage/session/:sessionId" element={<BandStagePage />} />
