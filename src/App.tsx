  ...
  return (
    <div className={`shell${isStageMode ? ' shell--stage' : ''}`}>
      ...
      <Routes>
        ...
        <Route path="/organizations" element={<OrganizationPage />} /><Route path="/bands" element={<BandListPage />} /><Route path="/bands/invite/:token" element={<BandInvitePage />} /><Route path="/bands/:bandId" element={<BandDetailPage />} />
